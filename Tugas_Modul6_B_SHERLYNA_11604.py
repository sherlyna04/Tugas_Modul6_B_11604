...
model = load_model(r'C:\Users\Sherlyna Alfelia\Documents\KULIAH\SMT 5\ML\Pertemuan 14\Tugas6_B_11604\model_mobilenet.h5')
...
def custom_progress_bar(confidence, color1, color2):
    ...
    <div style="border: 1px solid #ddd; border-radius: 5px; overflow: hidden; width: 100%; font-size: 14px;">
        ...
        <div style="widht: {percentage2:.2f}%; backgroung: {color2}; color: white; text-align: center; height: 24px; float: left;">
            {percentage2:.2f}%
        </div>
    </div>
    """
...
#Streamlit UI
st.title("Prediksi Kematangan Buah Naga = 1604")
